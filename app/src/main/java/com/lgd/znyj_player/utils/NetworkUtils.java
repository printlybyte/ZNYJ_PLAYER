...
public final class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        Applacationx.getAppContext().startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS)
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        ConnectivityManager manager =
                (ConnectivityManager) Applacationx.getAppContext().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager)Applacationx.getAppContext().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) Applacationx.getAppContext().getSystemService(Context.WIFI_SERVICE);
